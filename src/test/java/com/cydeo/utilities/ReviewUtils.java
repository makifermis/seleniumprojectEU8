...
// Let's get product's price
    ...
    public static double productRemover(WebDriver driver, String productName){
        double deletedItemPrice = Double.parseDouble(driver.findElement(By.xpath("(//td[.='"+productName+"']//following-sibling::td)[1]")).getText());

        driver.findElement(By.xpath("(//td[.='"+productName+"']//following::a)[1]")).click();
